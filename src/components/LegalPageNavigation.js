...
import { isClient, generateKey } from "../helpers";
import { MobileNavigationButton } from "./MobileNavigationButton";
import { NavigationItem } from "./NavigationItem";
import { getSectionId } from "../helpers";

const scrollToPageSection = (event, index, sectionTitle) => {
  if (event) event.preventDefault();
  const sectionId = getSectionId(index, sectionTitle);
      ...
      <div className="navigation-container">
        ...
        <ul
          ...
          sx={{
            ...
            opacity: [navOpen ? "1" : "0", navOpen ? "1" : "0", "1", "1"],
            zIndex: 2,
            boxShadow: [
